...
def main(model_name: str="google/gemma-1.1-2b-it",
    ...
    calib_if: InputFormatter = input_formatter_dict[calib_input_formatter_name](llm_bundle, PromptVersion.from_string(prompt_version))
    test_if: InputFormatter = input_formatter_dict[test_input_formatter_name](llm_bundle, PromptVersion.from_string(prompt_version))
